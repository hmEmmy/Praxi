...
public class Party {
	...
	public void invite(Player target) {
		...
		for (String msg : Locale.PARTY_INVITE.formatLines(leader.getName(), leader)) {
		...
		sendMessage(Locale.PARTY_INVITE_BROADCAST.format(target));
	}
	...
	public void join(Player player) {
		...
		sendMessage(Locale.PARTY_JOIN.format(player));
	...
	public void leave(Player player, boolean kick) {
		sendMessage(Locale.PARTY_LEAVE.format(player, (kick ? "been kicked from" : "left")));
