package me.emmy.practice.profile;

import me.emmy.practice.Practice;
import me.emmy.practice.profile.hotbar.Hotbar;
import me.emmy.practice.profile.hotbar.HotbarItem;
import me.emmy.practice.profile.meta.option.button.AllowSpectatorsOptionButton;
import me.emmy.practice.profile.meta.option.button.DuelRequestsOptionButton;
import me.emmy.practice.profile.meta.option.button.ShowScoreboardOptionButton;
import me.emmy.practice.profile.option.OptionsOpenedEvent;
import me.emmy.practice.profile.visibility.VisibilityLogic;
...
public class ProfileListener implements Listener {
	...
	public void onPlayerJoinEvent(PlayerJoinEvent event) {
		...
		for (String line : Practice.getInstance().getMainConfig().getStringList("JOIN_MESSAGES")) {
		...
		new BukkitRunnable() {
			...
			public void run() {
				Hotbar.giveHotbarItems(event.getPlayer());
				Practice.getInstance().getEssentials().teleportToSpawn(event.getPlayer());
		...
		}.runTaskLater(Practice.getInstance(), 4L);
	}
